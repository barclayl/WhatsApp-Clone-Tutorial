...
```ts
// FIXME: there is no such change in the following steps, maybe it has been backported?
...
Let's update the resolver to retrieve the `lastMessage` field:
...
#### Step 4.1: Replace REST call with GraphQL call
