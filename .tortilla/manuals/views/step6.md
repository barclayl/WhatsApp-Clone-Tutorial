...
[{]: <helper> (diffStep 4.3 files="tests/queries/__snapshots__" module="server")

#### Step 4.3: Add chat field to Query type

##### Added tests&#x2F;queries&#x2F;__snapshots__&#x2F;getChat.test.ts.snap
```diff
@@ -0,0 +1,16 @@
+┊  ┊ 1┊// Jest Snapshot v1, https://goo.gl/fbAQLP
+┊  ┊ 2┊
+┊  ┊ 3┊exports[`Query.chat should fetch specified chat 1`] = `
+┊  ┊ 4┊Object {
+┊  ┊ 5┊  "chat": Object {
+┊  ┊ 6┊    "id": "1",
+┊  ┊ 7┊    "lastMessage": Object {
+┊  ┊ 8┊      "content": "You on your way?",
+┊  ┊ 9┊      "createdAt": "2018-12-30T23:20:00.000Z",
+┊  ┊10┊      "id": "1",
+┊  ┊11┊    },
+┊  ┊12┊    "name": "Ethan Gonzalez",
...
```ts
// FIXME: the PR is merged and they fix should have been released in latest version
```
...
#### Step 6.2: Add basic ChatRoomScreen
...
#### Step 6.4: Test new navigation logic
...
#### Step 6.6: Implement ChatRoomScreen components
...
#### Step 6.8: Reset scroller on message sent
